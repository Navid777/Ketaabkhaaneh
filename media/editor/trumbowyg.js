    ...
    Trumbowyg.prototype = {
        ...
        unlink: function () {
            ...
            t.execCmd('unlink', undefined, undefined, true);
				...
				noSelectedElement: function () {
					var t = this;
					if (t.$selected == null) return true;
					if (t.$selected.parent() == null) {
						t.$selected = null;
						return true;
					}
					return false;
				...
				floatLeft: function () {
					...
					t.$selected.css('float', 'left');
				},
				floatRight: function () {
					var t = this;
					if (t.noSelectedElement()) return;
					t.$selected.css('float', 'right');
				},
				floatNone: function () {
					var t = this;
					if (t.noSelectedElement()) return;
					t.$selected.css('float', 'none');
				},
